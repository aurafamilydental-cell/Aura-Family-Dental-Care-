      ...
      <div className="flex flex-col gap-2.5">
        {services.slice(0, 3).map((name, i) => (
          <div
            ...
            style={i === 2 ? { maskImage: 'linear-gradient(to bottom, black 10%, transparent 100%)', WebkitMaskImage: 'linear-gradient(to bottom, black 10%, transparent 100%)', opacity: 0.7 } : {}}
          >
...
function BookBtn({ onClick }: { onClick: () => void }) {
  return (
    <button
      onClick={onClick}
      className="w-full sm:w-auto bg-[#f5d5f5] hover:bg-[#e8c0e8] text-[#141414] px-6 py-3.5 md:px-10 md:py-4 rounded-full font-medium text-base md:text-lg hover:shadow-xl hover:scale-[1.01] transition-all cursor-pointer shadow-lg whitespace-nowrap"
    >
