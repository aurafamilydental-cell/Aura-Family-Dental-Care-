          ...
          <div className="flex-grow grid grid-cols-2 md:grid-cols-5 gap-y-5 md:gap-y-8 gap-x-4 md:gap-6">
            ...
            <div className="flex flex-col space-y-2 md:space-y-3">
              ...
              <div className="flex items-center gap-3">
                <a href="https://www.instagram.com/aurafamilydent/" className="text-black hover:text-primary transition-colors" aria-label="Instagram">
                ...
                <a href="https://www.tiktok.com/@aurafamilydental" className="text-black hover:text-primary transition-colors" aria-label="TikTok">
